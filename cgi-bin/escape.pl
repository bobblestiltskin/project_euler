...
if ((defined $file) and ($file =~ m!^(?:perl|perl6|asm|forth|go|c|c\+\+|python|java|javascript|racket|erlang|ocaml|haskell|rust|tcl)/pe\d\d\d\.(?:pl|s|fs|go|c|cpp|py|java|js|rkt|erl|ml|hs|rs|tcl)$!)) {
