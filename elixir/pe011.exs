...
#    IO.puts("i is #{i}, j is #{j}, n is #{elem(elem(a, i), j)}")
    n  = elem(elem(a, i), j) * elem(elem(a, i - 1), j)     * elem(elem(a, i - 2), j)     * elem(elem(a, i - 3), j)
    ne = elem(elem(a, i), j) * elem(elem(a, i - 1), j + 1) * elem(elem(a, i - 2), j + 2) * elem(elem(a, i - 3), j + 3)
    e  = elem(elem(a, i), j) * elem(elem(a, i), j + 1)     * elem(elem(a, i), j + 2)     * elem(elem(a, i), j + 3)
    se = elem(elem(a, i), j) * elem(elem(a, i + 1), j + 1) * elem(elem(a, i + 2), j + 2) * elem(elem(a, i + 3), j + 3)
    s  = elem(elem(a, i), j) * elem(elem(a, i + 1), j)     * elem(elem(a, i + 2), j)     * elem(elem(a, i + 3), j)
    sw = elem(elem(a, i), j) * elem(elem(a, i + 1), j - 1) * elem(elem(a, i + 2), j - 2) * elem(elem(a, i + 3), j - 3)
    w  = elem(elem(a, i), j) * elem(elem(a, i), j - 1)     * elem(elem(a, i), j - 2)     * elem(elem(a, i), j - 3)
    nw = elem(elem(a, i), j) * elem(elem(a, i - 1), j - 1) * elem(elem(a, i - 2), j - 2) * elem(elem(a, i - 3), j - 3)
