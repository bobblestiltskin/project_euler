...
void call_mul_digit_string(const int, const std::vector<int>, const std::vector< std::string >, const std::vector< std::string >);
...
void call_mul_digit_string(const int index, const std::vector<int> scalars, const std::vector< std::string > numeric_input, const std::vector< std::string > numeric_output)
{
